    ...
    return (
      <LegalPage title="Privacy Policy">
        ...
        <section>
          <h2>1. Who we are</h2>
          <p>
            Bladiq (&ldquo;we&rdquo;, &ldquo;us&rdquo;) operates a booking platform used by local businesses
  ...
  return (
    <LegalPage title="Datenschutzerklärung">
      ...
      <section>
        ...
        <p>
          Bladiq (&ldquo;wir&rdquo;) betreibt eine Buchungsplattform für lokale Unternehmen
